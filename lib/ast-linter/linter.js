...
class Linter {
     ...
     * @param {object[]?} options.queries - list of registered theme queries in [{}, {}] format
     ...
     */
    constructor(options = {partials: [], helpers: [], queries: [], inlinePartials: [], customThemeSettings: {}}) {
   ...
   */
    verify(options) {
        ...
        if (scanner.context.queries) {
            this.queries = scanner.context.queries;
        }
